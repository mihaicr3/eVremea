...
public class CoordinatesSelectFromDatabase {
    public static CurrentWeather selectWeather(String lat,String lon, long timestampToRemove) throws SQLException {
        ...
        try (PreparedStatement statement = connection.prepareStatement("""
            ...
            statement.setLong(3, timestampToRemove);
